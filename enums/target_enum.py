...
class TargetEnum(Enum):
    TARGET_NONE = {TargetKeys.VALUE_IN_RULE: RulesReservedKeys.TARGET_TYPE_NONE,TargetKeys.CLANG_KINDS:[],TargetKeys.CLANG_LINKAGE_KIND:[],TargetKeys.CLANG_ACCESS_KIND:None}
    ...
    TARGET_DEFINE = {TargetKeys.VALUE_IN_RULE:RulesReservedKeys.TARGET_TYPE_DEFINES,TargetKeys.CLANG_KINDS:[CursorKind.MACRO_DEFINITION], TargetKeys.CLANG_LINKAGE_KIND:[LinkageKind.INTERNAL],TargetKeys.CLANG_ACCESS_KIND:None}